  ...
  return (
    ...
    >
      ...
      {open && (
        <div
          id="mobile-menu"
          className="fixed top-[calc(4rem+2rem)] left-0 right-0 bottom-0 z-40 bg-white/98 backdrop-blur-xl border-t border-gray-100 md:hidden overflow-y-auto"
        >
          <div className="flex flex-col p-6 gap-2">
            {links.map((link) => (
              <a
                ...
                className={cn(
                  ...
                  link.external
                    ? "bg-red-600 text-white text-center mt-2"
                    : "text-gray-700 hover:text-red-600 hover:bg-red-50"
                )}
              >
                {link.label}
            ...
            <div className="mt-6 pt-6 border-t border-gray-100 text-center">
              <a href="tel:+919944994417" className="text-red-600 font-semibold text-lg">
                📞 +91 9944994417
              </a>
              <p className="text-gray-500 text-sm mt-1">Open 11 AM – 3 AM</p>
            </div>
          </div>
        </div>
      )}
